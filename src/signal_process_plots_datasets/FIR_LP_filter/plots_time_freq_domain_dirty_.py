...
from LP_filter_firwin_method_ import lp_firwin, filt_sig
from file_import import data_import
...
if __name__=='__main__':
    ...
    for i,j,k in zip(MATRIX_RAW, Filt, Titles):
    ...
    for i,j,t,f,c in zip(MATRIX_RAW, Filt, raw_titles, filt_titles, colors_filt):
    ...
    for i,j,t3,t4 in zip(MATRIX_RAW, Filt, raw_titles_spec, filt_titles_spec):
    ...
    for i,j,k,t1,t2 in zip(MATRIX_RAW,Blank,Filt,blank_freq_dom_titles,shifted_freq_dom_titles):
